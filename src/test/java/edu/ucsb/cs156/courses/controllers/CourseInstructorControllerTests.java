...
@WebMvcTest(value = CourseInstructorController.class)
@Import(SecurityConfig.class)
@AutoConfigureDataJpa
public class CourseInstructorControllerTests {
    private final Logger logger = LoggerFactory.getLogger(CourseInstructorControllerTests.class);
    ...
    public void test_search_emptyRequest() throws Exception {
        ...
        String urlTemplate = "/api/public/courseinstructor/search?startQtr=%s&endQtr=%s&instructor=%s";
    ...
    @Test public void test_search_validRequestWithoutSuffix() throws Exception {
        ...
        String url = String.format(urlTemplate, "20222", "20222", "Conrad");

        List<ConvertedSection> expectedSecs = new ArrayList<ConvertedSection>();
        expectedSecs.addAll(Arrays.asList(cs1, cs2));

        // mock
        when(convertedSectionCollection.findByQuarterRangeAndInstructor(any(String.class), any(String.class), eq("Conrad"))).thenReturn(expectedSecs);
